		...
		"src": {
			"client": {
				"sandbox": {
					...
					"fetch.js": function (exports, module, require) {
						...
						var internal_header_names_1 = __importDefault(require("../../request-pipeline/internal-header-names"));
						...
						var same_origin_check_failed_status_code_1 = __importDefault(require("../../request-pipeline/xhr/same-origin-check-failed-status-code"));
						...
						var DEFAULT_REQUEST_CREDENTIALS = native_methods_1.default.Request ? new native_methods_1.default.Request(location.toString()).credentials : void 0;
						...
						var FetchSandbox = /*#__PURE__*/function (_sandbox_base_with_de) {
						  ...
						  FetchSandbox._addSpecialHeadersToRequestInit = function _addSpecialHeadersToRequestInit(init) {
						    ...
						    native_methods_1.default.headersSet.call(headers, internal_header_names_1.default.origin, destination_location_1.getOriginHeader());
						    native_methods_1.default.headersSet.call(headers, internal_header_names_1.default.credentials, credentials);
						    ...
						    if (authorizationValue !== null) {
						      native_methods_1.default.headersSet.call(headers, internal_header_names_1.default.authorization, authorizationValue);
						      native_methods_1.default.headersDelete.call(headers, builtin_header_names_1.default.authorization);
						    }

						    if (proxyAuthorizationValue !== null) {
						      native_methods_1.default.headersSet.call(headers, internal_header_names_1.default.proxyAuthorization, proxyAuthorizationValue);
						      native_methods_1.default.headersDelete.call(headers, builtin_header_names_1.default.proxyAuthorization);
						    }
						  ...
						  FetchSandbox._processArguments = function _processArguments(args) {
						    ...
						    var inputIsFetchRequest = dom_1.isFetchRequest(input);

						    if (!inputIsFetchRequest) {
						      args[0] = url_1.getProxyUrl(inputIsString ? input : String(input));
						      args[1] = FetchSandbox._addSpecialHeadersToRequestInit(init || {});
						    } else if (init && init.headers && input.destination !== 'worker') args[1] = FetchSandbox._addSpecialHeadersToRequestInit(init);
						  };

						  FetchSandbox._sameOriginCheck = function _sameOriginCheck(_ref) {
						    var input = _ref[0],
						        init = _ref[1];
						    var isRequest = dom_1.isFetchRequest(input);
						    var url = isRequest ? url_1.getDestinationUrl(native_methods_1.default.requestUrlGetter.call(input)) : url_1.getDestinationUrl(input);
						    var requestMode = isRequest ? input.mode : init && init.mode;
						    if (requestMode === 'same-origin') return destination_location_1.sameOriginCheck(destination_location_1.get(), url);
						    return true;
						  };

						  FetchSandbox._getResponseType = function _getResponseType(response) {
						    var destUrl = url_1.getDestinationUrl(native_methods_1.default.responseUrlGetter.call(response));
						    var isSameOrigin = destination_location_1.sameOriginCheck(destination_location_1.get(), destUrl);
						  ...
						  FetchSandbox._entriesFilteredNext = function _entriesFilteredNext(iterator, nativeNext) {
						    ...
						    if (headerName === internal_header_names_1.default.origin || headerName === internal_header_names_1.default.credentials) return FetchSandbox._entriesFilteredNext(iterator, nativeNext);
						    entry.value[0] = headers_1.transformHeaderNameToBuiltin(headerName); // eslint-disable-line no-restricted-properties
						  ...
						  _proto.attach = function attach(window) {
						    ...
						    overriding_1.overrideFunction(window, 'fetch', function () {
						      ...
						      if (!FetchSandbox._sameOriginCheck(args)) // @ts-ignore
						        return native_methods_1.default.promiseReject.call(sandbox.window.Promise, new TypeError());
						      window.Headers.prototype.entries = window.Headers.prototype[Symbol.iterator] = native_methods_1.default.headersEntries;
						    ...
						    overriding_1.overrideDescriptor(window.Response.prototype, 'type', {
						      getter: function getter() {
						        return FetchSandbox._getResponseType(this);
						      }
						    });
						    overriding_1.overrideDescriptor(window.Response.prototype, 'status', {
						      getter: function getter() {
						        var responseStatus = native_methods_1.default.responseStatusGetter.call(this);
						        return responseStatus === same_origin_check_failed_status_code_1.default ? 0 : responseStatus;
						      }
						    });
						    ...
						    overriding_1.overrideFunction(window.Headers.prototype, 'forEach', function () {
						      ...
						      if (typeof callback === 'function') {
						        args[0] = function (value, name, headers) {
						          // eslint-disable-next-line no-restricted-properties
						          if (name === internal_header_names_1.default.origin || name === internal_header_names_1.default.credentials) return;
						          name = headers_1.transformHeaderNameToBuiltin(name);
						    ...
						    overriding_1.overrideFunction(window.Headers.prototype, 'get', function () {
						      ...
						      args[0] = headers_1.transformHeaderNameToInternal(headerName);
						      var result = native_methods_1.default.headersGet.apply(this, args);

						      if (result === null) {
						        args[0] = headerName;
						        return native_methods_1.default.headersGet.apply(this, args);
						      }

						      return result;
						    });
						    overriding_1.overrideFunction(window.Headers.prototype, 'has', function () {
						      ...
						      var headerName = args[0];
						      args[0] = headers_1.transformHeaderNameToInternal(headerName);
						      var result = native_methods_1.default.headersHas.apply(this, args);

						      if (!result) {
						        args[0] = headerName;
						        return native_methods_1.default.headersHas.apply(this, args);
						      }
						    ...
						    overriding_1.overrideFunction(window.Headers.prototype, 'set', function () {
						      ...
						      args[0] = headers_1.transformHeaderNameToInternal(args[0]);
					...
					"native-methods.js": function (exports, module, require) {
						...
						var NativeMethods = /*#__PURE__*/function () {
						  function NativeMethods(doc, win) {
						    var globalCtx = global_context_info_1.default();
						...
						var XhrSandbox = /*#__PURE__*/function (_sandbox_base_with_de) {
						  ...
						  _proto.attach = function attach(window) {
						    ...
						    for (var _i2 = 0; _i2 < XHR_READY_STATES.length; _i2++) {
						      ...
						      native_methods_1.default.objectDefineProperty(xmlHttpRequestWrapper, readyState, {
						    ...
						    overriding_1.overrideFunction(xmlHttpRequestProto, 'abort', function () {
						      ...
						      if (xhrSandbox.gettingSettingInProgress()) {
						        xhrSandbox.delayUntilGetSettings(function () {
						          return _this2.abort.apply(_this2, args);
						        });
						        return;
						      }

						      native_methods_1.default.xhrAbort.apply(this, arguments);
						    ...
						    overriding_1.overrideFunction(xmlHttpRequestProto, 'open', function () {
						      ...
						      if (url_1.getProxyUrl(url) === url) {
						        native_methods_1.default.xhrOpen.apply(this, arguments);
						        return;
						      }
						      ...
						      arguments[1] = url_1.getProxyUrl(urlIsString ? url : String(url));
						      native_methods_1.default.xhrOpen.apply(this, arguments);
						    });
						    overriding_1.overrideFunction(xmlHttpRequestProto, 'send', function () {
						      ...
						      native_methods_1.default.xhrSetRequestHeader.call(this, internal_header_names_1.default.origin, destination_location_1.getOriginHeader());
						      native_methods_1.default.xhrSetRequestHeader.call(this, internal_header_names_1.default.credentials, this.withCredentials ? 'include' : 'same-origin');
						      native_methods_1.default.xhrSend.apply(this, arguments); // NOTE: For xhr with the sync mode
						    ...
						    overriding_1.overrideFunction(xmlHttpRequestProto, 'setRequestHeader', function () {
						      ...
						      args[0] = headers_1.transformHeaderNameToInternal(args[0]);
						      return native_methods_1.default.xhrSetRequestHeader.apply(this, args);
						    });
						    overriding_1.overrideDescriptor(window.XMLHttpRequest.prototype, 'status', {
						      getter: function getter() {
						        var status = native_methods_1.default.xhrStatusGetter.call(this);
						        return status === same_origin_check_failed_status_code_1.default ? 0 : status;
						      }
						    });
						    ...
						    overriding_1.overrideFunction(xmlHttpRequestProto, 'getResponseHeader', function () {
						      ...
						      args[0] = headers_1.transformHeaderNameToInternal(args[0]);
						      return native_methods_1.default.xhrGetResponseHeader.apply(this, args);
						    });
						    overriding_1.overrideFunction(xmlHttpRequestProto, 'getAllResponseHeaders', function () {
						      var allHeaders = native_methods_1.default.xhrGetAllResponseHeaders.apply(this, arguments);
						      return allHeaders.replace(internal_header_names_1.default.wwwAuthenticate, builtin_header_names_1.default.wwwAuthenticate).replace(internal_header_names_1.default.proxyAuthenticate, builtin_header_names_1.default.proxyAuthenticate);
						    });
						  };
				...
				"utils": {
					...
					"destination-location.js": function (exports, module, require) {
						...
						function getLocation() {
						  ...
						  var globalCtx = global_context_info_1.default().global;
					...
					"headers.js": function (exports, module, require) {
						...
						BUILTIN_TO_INTERNAL_HEADERS_MAP.set(builtin_header_names_1.default.authorization, internal_header_names_1.default.authorization);
						BUILTIN_TO_INTERNAL_HEADERS_MAP.set(builtin_header_names_1.default.proxyAuthorization, internal_header_names_1.default.proxyAuthorization);
						BUILTIN_TO_INTERNAL_HEADERS_MAP.set(builtin_header_names_1.default.wwwAuthenticate, internal_header_names_1.default.wwwAuthenticate);
						BUILTIN_TO_INTERNAL_HEADERS_MAP.set(builtin_header_names_1.default.proxyAuthenticate, internal_header_names_1.default.proxyAuthenticate);
						INTERNAL_TO_BUILTIN_HEADERS_MAP.set(internal_header_names_1.default.authorization, builtin_header_names_1.default.authorization);
						INTERNAL_TO_BUILTIN_HEADERS_MAP.set(internal_header_names_1.default.proxyAuthorization, builtin_header_names_1.default.proxyAuthorization);
						INTERNAL_TO_BUILTIN_HEADERS_MAP.set(internal_header_names_1.default.wwwAuthenticate, builtin_header_names_1.default.wwwAuthenticate);
						INTERNAL_TO_BUILTIN_HEADERS_MAP.set(internal_header_names_1.default.proxyAuthenticate, builtin_header_names_1.default.proxyAuthenticate);

						function transformHeaderName(headerName, replacements) {
						  if (typeof headerName === 'string') return replacements.get(headerName.toLowerCase()) || headerName;
						  return headerName;
						}
						  ...
						  /*FetchEvent*/
						    ...
						    if (!isInternalRequest) {
						      ...
						      if (isPage) {
						        ...
						        if (isCorrectScope(parsedProxyReferrer.destResourceInfo)) return;
						      }
			...
			"request-pipeline": {
				...
				"internal-header-names.js": function (exports, module, require) {
					...
					var builtin_header_names_1 = __importDefault(require("./builtin-header-names"));

					var hammerheadPrefix = 'x-hammerhead-';
					exports.default = {
					  credentials: hammerheadPrefix + 'credentials',
					  origin: hammerheadPrefix + builtin_header_names_1.default.origin,
					  wwwAuthenticate: hammerheadPrefix + builtin_header_names_1.default.wwwAuthenticate,
					  proxyAuthenticate: hammerheadPrefix + builtin_header_names_1.default.proxyAuthenticate,
					  authorization: hammerheadPrefix + builtin_header_names_1.default.authorization,
					  proxyAuthorization: hammerheadPrefix + builtin_header_names_1.default.proxyAuthorization
					};
					module.exports = exports.default;
				},
				"xhr": {
			...
			"utils": {
				...
				"url.js": function (exports, module, require) {
					...
					function getResourceTypeString(resourceType) {
					  ...
					  if (!resourceType.isIframe && !resourceType.isForm && !resourceType.isScript && !resourceType.isEventSource && !resourceType.isHtmlImport && !resourceType.isWebSocket && !resourceType.isServiceWorker) return null;
					  return [resourceType.isIframe ? 'i' : '', resourceType.isForm ? 'f' : '', resourceType.isScript ? 's' : '', resourceType.isEventSource ? 'e' : '', resourceType.isHtmlImport ? 'h' : '', resourceType.isWebSocket ? 'w' : '', resourceType.isServiceWorker ? 'c' : ''].join('');
					}
					...
					function parseRequestDescriptor(desc) {
					  var params = desc.split(exports.REQUEST_DESCRIPTOR_VALUES_SEPARATOR);
					  if (!params.length) return null;
					  var sessionInfo = params[0].split(exports.REQUEST_DESCRIPTOR_SESSION_INFO_VALUES_SEPARATOR);
					  ...
					  if (resourceType && resourceData) {
					    var parsedResourceType = parseResourceType(resourceType);
					    if (parsedResourceType.isScript || parsedResourceType.isServiceWorker) parsedDesc.charset = resourceData;else if (parsedResourceType.isWebSocket) parsedDesc.reqOrigin = decodeURIComponent(resourceData);
					  }
