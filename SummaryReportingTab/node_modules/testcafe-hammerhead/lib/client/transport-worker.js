			...
			"client": {
				...
				"transport-worker": {
					"index.js": function (exports, module, require) {
						...
						var consts_1 = require("../transport/consts");
						...
						function asyncServiceMsg(msg, callback) {
						  request_1.default(serviceMsgUrl, msg, function (err, data) {
						    return callback({
						      err: err,
						      data: data
						    });
						...
						var messageListener = function messageListener(e) {
						  if (e.data.cmd === consts_1.SET_INITIAL_WORKER_SETTINGS_CMD) {
						    var settings = e.data;
						    serviceMsgUrl = settings.serviceMsgUrl;
						    sessionId = settings.sessionId;
						  } else if (e.data.cmd === consts_1.HANDLE_PORT_CMD) e.ports[0].onmessage = messageListener;else {
